...
class DataSaverNode(Node):
    ...
    def left_camera_info_callback(self, msg: CameraInfo):
        ...
        udist_camera_matrix = {"camera_matrix": new_camera_matrix.tolist()}
    ...
    def timer_callback(self):
        ...
        with open(f"{self.save_path}/left/{self.counter:06d}_tf.json", "w") as f:
        ...
        with open(f"{self.save_path}/right/{self.counter:06d}_tf.json", "w") as f:
