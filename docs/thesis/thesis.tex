...
\newcommand{\vikkonzulensAVezeteknev}{Sörös (Nokia Bell Labs)}
...
\include{content/experiments-oak_d}
\include{content/experiments-3d_mapping}
\include{content/experiments-nerf_gaussian_splat}
